...
*local0 = arg0;
block2:(void)0;
const int(*local3)(const int*) = *local33;
...
int local1[1];
*local1 = 20;
const int(*local3)(const int*) = *local113;
...
const int*** local13[1];
*local13 = local11;
const int(*local15)(const int***) = *local113;
...
const int*** local26[1];
*local26 = local24;
const int(*local28)(const int) = *local113;
...
int local34[1];
*local34 = local33;
const int(*local36)(const int) = *local113;
