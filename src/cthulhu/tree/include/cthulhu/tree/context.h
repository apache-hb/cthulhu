...
typedef void (*tree_resolve_t)(IN_NOTNULL const tree_context_t *context, IN_NOTNULL tree_t *tree);

// resolve only the type of a declaration
typedef void (*tree_resolve_type_t)(IN_NOTNULL const tree_context_t *context, IN_NOTNULL tree_t *tree);
...
// TODO: make the extra take a per language key to verify the type
