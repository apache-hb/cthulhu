...
CT_UTIL_API text_t util_text_escape(IN_NOTNULL logger_t *reports, IN_NOTNULL const node_t *node, STA_READS(length) const char *text, size_t length, IN_NOTNULL arena_t *arena);
