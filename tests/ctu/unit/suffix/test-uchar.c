...
int main(void) {
    ...
    node_t *base10 = ast_digit(NULL, NOWHERE, ctu_strdup("100ut"), 10);
    node_t *base2 = ast_digit(NULL, NOWHERE, ctu_strdup("100ut"), 2);
    node_t *base16 = ast_digit(NULL, NOWHERE, ctu_strdup("100ut"), 16);
    ...
    ASSERT(base10->integer == INTEGER_CHAR)("base10 type incorrect, got `%d`", base10->integer);
    ...
    ASSERT(base2->integer == INTEGER_CHAR)("base2 type incorrect, got `%d`", base2->integer);
    ...
    ASSERT(base16->integer == INTEGER_CHAR)("base16 type incorrect, got `%d`", base16->integer);
