...
int main(void) {
    ...
    node_t *base10 = ast_digit(NULL, NOWHERE, ctu_strdup("100z"), 10);
    node_t *base2 = ast_digit(NULL, NOWHERE, ctu_strdup("100z"), 2);
    node_t *base16 = ast_digit(NULL, NOWHERE, ctu_strdup("100z"), 16);
