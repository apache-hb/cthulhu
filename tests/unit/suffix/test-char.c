...
int main(void) {
    ...
    node_t *base10 = ast_digit(NULL, NOWHERE, ctu_strdup("100t"), 10);
    node_t *base2 = ast_digit(NULL, NOWHERE, ctu_strdup("100t"), 2);
    node_t *base16 = ast_digit(NULL, NOWHERE, ctu_strdup("100t"), 16);
