...
int main(void) {
    ...
    node_t *base10 = ast_digit(NULL, NOWHERE, strdup("100m"), 10);
    node_t *base2 = ast_digit(NULL, NOWHERE, strdup("100m"), 2);
    node_t *base16 = ast_digit(NULL, NOWHERE, strdup("100m"), 16);
