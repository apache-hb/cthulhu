...
int main(void) {
    ...
    node_t *base10 = ast_digit(NULL, NOWHERE, strdup("100i"), 10);
    node_t *base2 = ast_digit(NULL, NOWHERE, strdup("100i"), 2);
    node_t *base16 = ast_digit(NULL, NOWHERE, strdup("100i"), 16);
